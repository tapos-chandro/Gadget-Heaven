...
const NavBar = () => {
  ...
  const activeLink = ({ isActive }) => ({
    color: isActive ? location.pathname === '/'? '#fff' :'#9538E2': '',
  ...
  let navLinks = 
    <>
      ...
      <li >
        <NavLink to='/statistics' style={activeLink} className='flex justify-center w-full text-center'>
        Statistics
        </NavLink>
      </li>
      <li>
        <NavLink to='/dashboard' style={activeLink} className='flex justify-center w-full text-center'>Dashboard</NavLink >
      </li>
    </>
  

  return (
    <div className={`navbar  lg:grid lg:grid-cols-3 lg:justify-between py-7`}>
      <div className='p-0 navbar '>
        <a href='/' className='text-3xl font-bold text-black'>Gadget Heaven</a>
      </div>
      ...
      <div className='hidden lg:block'>
        <div className='flex justify-end gap-4'>
          <button className='rounded-full text-lg bg-white p-2'><IoCartOutline /></button>
